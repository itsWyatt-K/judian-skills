...
本包方法论整理自 **visual-skills**（Serge Shima — github.com/smixs/visual-skills，CC BY 4.0，基于原作出修改）。
按 CC BY 4.0 第 3(a) 条，任何分享本包或其衍生品的行为必须保留上述署名行。
完整来源、许可证全文与修改声明见本目录 [THIRD-PARTY-LICENSES.md](THIRD-PARTY-LICENSES.md)。
