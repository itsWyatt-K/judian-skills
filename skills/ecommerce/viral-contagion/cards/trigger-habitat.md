...
description: "当需要用户的产品\"好但只在特定场景被想起\"——需要扩展栖息地，将产品绑定到更多日常场景。；用户的营销活动\"一开始很火但很快就没时调用。核心能力：诱因栖息地开发模型。关键触发：好但只在特定场景被想起、一开始很火但很快就没人提了、明明产品差不多，但用户讨论度远高于我、怎么让产品持续被记住？。不适用于：产品本身有严重体验问题——用户被诱因想起产品后如果体验差，反而产生负面口碑。、纯。"
tags: ["诱因", "栖息地", "持续口碑", "日常激活", "口碑传播"]
metadata:
  source_book: "《疯传——让你的产品、思想、行为像病毒一样入侵》 乔纳·伯杰"
  attribution: "Original methodology rewritten by the Judian project from published-book distillation cards; inspired by the cited books, no original expression reproduced."
  source_card: "classics\\疯传\\蒸馏skill\\trigger-habitat\\SKILL.md"
---
