...
description: "当需要分析一个商业/技术/组织问题但只用了一个维度的解释框架(如只看财务、只看技术、只看市场)；面对复杂现象,现有的分析工具无时调用。核心能力：多元思维模型框架。关键触发：总觉得还缺了什么、这个问题应该就是XX方面的问题、我主要是从XX角度来看的、我不太懂XX领域,所以没法判断。不适用于：问题非常简单,单维分析已经足够(强行引入多学科模型是过度工程化)、时间紧迫,需要。"
tags: ["跨学科思维", "思维模型", "普世智慧", "铁锤人倾向"]
metadata:
  source_book: "《穷查理宝典》 查理·芒格"
  attribution: "Original methodology rewritten by the Judian project from published-book distillation cards; inspired by the cited books, no original expression reproduced."
  source_card: "classics\\穷查理宝典\\蒸馏skill\\latticework-mental-models\\SKILL.md"
---
