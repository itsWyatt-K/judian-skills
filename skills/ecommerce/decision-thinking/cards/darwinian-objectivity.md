...
description: "当需要形成了强烈的观点/结论后,在付诸行动前需要检验其可靠性；发现自己开始排斥与已有观点矛盾的信息,或只寻找支持性证据时调用。核心能力：达尔文极端客观性方法。关键触发：我觉得这肯定是对的/不可能错、有什么证据能反驳我的判断?、大家都同意这个方案、我越是想越觉得有道理。不适用于：紧急决策场景——当你只有几分钟做出判断时,系统性地搜索反面证据不现实、在信息收集。"
