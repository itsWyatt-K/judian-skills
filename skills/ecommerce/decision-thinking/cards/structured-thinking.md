...
description: "当用户说\"这件事太复杂了，怎么拆？\"、\"我不确定有没有遗漏\"、\"怎么表达才更有条理？\"时调用。核心能力：结构化思维与MECE。关键触发：这件事太复杂了，怎么拆？、我不确定有没有遗漏、怎么表达才更有条理？、帮我把这些内容整理一下。"
tags: []
metadata:
  source_book: "认知红利"
  attribution: "Methodological framework re-derived and rewritten by the Judian project from published-book methodology notes; inspired by the cited books, no original expression reproduced."
  source_card: "classics\\认知红利\\整理skill\\structured-thinking\\SKILL.md"
evidence: E4
