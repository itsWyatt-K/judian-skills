...
description: "当需要在投资/项目失败后,感到强烈的\"必须扳回来\"的冲动,考虑加注而非止损；在竞拍/谈判中,因为\"差点就赢了\"而产生不理性的加时调用。核心能力：被剥夺超级反应倾向防范。关键触发：必须扳回来、差点就赢了、已经投入了这么多、已经投了这么多,不能现在放弃。不适用于：对正常的损失厌恶(如不愿意亏钱)做过度诊断——正常的风险规避不需要\"治疗\"。"
