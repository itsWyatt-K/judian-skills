...
description: "当用户说\"必须选一个\"、\"纠结选A还是B\"、\"两个都不好，但必须选一个\"时调用。核心能力：科学决策与第三选择。关键触发：必须选一个、纠结选A还是B、两个都不好，但必须选一个、帮我做个决定。"
tags: []
metadata:
  source_book: "认知红利"
  attribution: "Methodological framework re-derived and rewritten by the Judian project from published-book methodology notes; inspired by the cited books, no original expression reproduced."
  source_card: "classics\\认知红利\\整理skill\\scientific-decision\\SKILL.md"
evidence: E4
