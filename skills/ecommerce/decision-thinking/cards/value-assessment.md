...
description: "当需要评估一项投资(股票/基金/创业项目)是否值得投入,需要系统化分析其内在价值；在市场恐慌或狂热时,判断当前价格相对于价值是时调用。核心能力：价值评估原则。关键触发：这只股票/这个项目值不值得买?、这个价格合理吗/安全边际够不够?、这家公司有没有护城河/定价权?、现在市场这么恐慌/狂热,是不是机会?。不适用于：评估短线交易机会(芒格框架专为长期持有设计)、在不理解的领域(能力圈外)强行\"计。"
tags: ["投资评估", "安全边际", "护城河", "定价权"]
metadata:
  source_book: "《穷查理宝典》 查理·芒格"
  attribution: "Original methodology rewritten by the Judian project from published-book distillation cards; inspired by the cited books, no original expression reproduced."
  source_card: "classics\\穷查理宝典\\蒸馏skill\\value-assessment\\SKILL.md"
---
