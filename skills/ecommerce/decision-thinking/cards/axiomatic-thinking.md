...
description: "当需要需要构建一个完整的知识体系或方法论框架；面对一个复杂系统，想要找到底层原理时调用。核心能力：公理化思维框架。关键触发：第一性原理、几条核心原理、这件事的本质/底层逻辑是什么、能不能从根本原理推导出来。不适用于：处理纯粹经验性问题（如A/B测试、用户反馈分析）—— 归纳法在此更有效。"
