...
description: "当需要被要求负责或评估一个自己没有深度经验的领域(新项目、新行业、新岗位)；面对\"好机会\"但不确定自己是否真正理解其核心逻辑时调用。核心能力：能力圈判断。关键触发：我可以学、应该差不多、这个不难吧、虽然我没做过,但感觉跟XX差不多。不适用于：用户已有长期成功记录的领域(过度自疑会错失机会)、早期探索阶段,需要通过试错来拓。"
