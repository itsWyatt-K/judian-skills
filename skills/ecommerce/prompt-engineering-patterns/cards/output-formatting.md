...
description: "当用户说\"回复太长了/太啰嗦了\"、\"输出格式需要适配手机屏幕\"、\"不要那些 AI 常用的套话\"时调用。核心能力：输出格式与风格控制。关键触发：回复太长了/太啰嗦了、输出格式需要适配手机屏幕、不要那些 AI 常用的套话、简洁一点，像终端工具那样输出。不适用于：用户明确要求某种特定格式（如 JSON Schema、XML）— 这属于数据契约。"
tags: ["输出格式", "风格控制", "反AI味", "自适应长度", "平台适配"]
metadata:
  source_book: "系统提示词设计模式库"
  attribution: "Original methodology rewritten by the Judian project from published-book distillation cards; inspired by the cited books, no original expression reproduced."
  source_card: "classics\\系统提示词设计模式库\\蒸馏skill\\output-formatting\\SKILL.md"
---
