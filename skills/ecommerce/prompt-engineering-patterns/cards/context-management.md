...
description: "当用户说\"AI 忘记了之前说过的内容\"、\"对话太长后回答质量下降\"、\"token 成本太高了\"时调用。核心能力：上下文与窗口管理。关键触发：AI 忘记了之前说过的内容、对话太长后回答质量下降、token 成本太高了、需要记住用户的偏好/项目背景。不适用于：单轮交互系统——没有上下文需要管理、上下文窗口远大于实际使用量——预算管理没有实。"
