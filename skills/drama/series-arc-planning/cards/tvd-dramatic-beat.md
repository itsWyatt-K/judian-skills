---
name: tvd-dramatic-beat
description: "当需要用户写完一场戏但感觉\"温吞/没张力\"，想检查这场到底有没有戏、冲突在哪。；用户写了过渡戏（角色走路/发呆/独白），犹豫该时调用。核心能力：tvd-dramatic-beat — 戏剧节拍。关键触发：温吞/没张力、一集有几条并行线、线里**每一个场景单元** 有没有动力、集级结构 （分幕/锚点）。"
tags: ["scene-craft", "dramatic-beat", "scene-quality"]
metadata:
